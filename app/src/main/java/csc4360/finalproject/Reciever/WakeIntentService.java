...
// unlock the system if requested : in our case we request it in case of alarm broadcast
public abstract class WakeIntentService extends IntentService {
    ...
    // if system is sleep mode (screen is off) it wake the system and unlock the screen

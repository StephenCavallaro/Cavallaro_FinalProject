...
public class ReminderFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // If this screen is displayed for the first time
        if (isFirstTime) {
            populateList();
        }
    ...
    // Edit note function. Parameter position is note index
    ...
    public void populateList() {
        ...
        // Get all notes (those having reminder alert)
        notesArrayList = databaseHelper.getReminderNotes();
        ...
        // in the listview at the same time
